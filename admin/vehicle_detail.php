    ...
    <div class="row">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="vehicles.php">Список Транспорта</a></li>
                <li><a href="vehicles.php">Редактор Транспорта</a></li>
            ...
            <div class="thumbnail">
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <p style="text-align: center;">Расположение: <?php echo $row->plate;?> - Цвет: <?php echo $row->color;?></p>
                    </li>
                    <li class="list-group-item">
                        <h4 style="margin-top: 10px !important;">
                            ...
                            <?php 
                            if ($row->side == "cop"){
                                echo "<span class='label label-primary' style='margin-right:3px;'><strong>Полицейский Транспорт</strong></span>";
                            }
                            elseif ($row->side == "med"){
                                echo "<span class='label label-danger' style='margin-right:3px;'><strong>Медицинский Транспорт</strong></span>";
                            }
                            elseif ($row->side == "civ"){
                                echo "<span class='label label-default' style='margin-right:3px;'><strong>Гражданский Транспорт</strong></span>";
                            }
                            if ($row->active == 1){
                                echo "<span class='label label-success' style='margin-right:3px;'><strong>Активен</strong></span>";
                            }
                            else{
                                echo "<span class='label label-default' style='margin-right:3px;'><strong>В гараже</strong></span>";
                            }
                            if($row->alive == 1){
                                echo "<span class='label label-info' style='margin-right:3px;'><strong>Неразрушенный</strong></span>";
                            }
                            else{
                                echo "<span class='label label-default' style='margin-right:3px;'><strong>Уничтоженный</strong></span>";
                            }
                            ?>
                            </p>
                        </h4>
                    ...
                    <li class="list-group-item">
                        <p class="text-center">Инвентарь</p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="glyphicon glyphicon-pencil"></span> Изменить Транспортное Средство</h4>
            </div>
            ...
            <form method="post" action="vehicle_detail.php?id=<?php echo $row->id;?>" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <p>Do you realy want to delete the Vehicle <strong>"<?php echo $row->classname;?>" </strong>- Владелец <strong><?php echo $row->name;?></strong> ?</p>                                    
                    </div>
                </div>
                <div class="modal-footer">
