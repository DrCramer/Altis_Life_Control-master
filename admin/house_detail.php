                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <h4 style="margin-top: 10px !important;">
                            ...
                            <?php 
                            if ($row->owned == 1){
                                echo "<span class='label label-success' style='margin-right:3px;'><strong>Owned</strong></span>";
                            }
                            else{
                                echo "<span class='label label-default' style='margin-right:3px;'><strong>Free</strong></span>";
                            }
                            ?>
                            </p>
                        </h4>
                    ...
                    <li class="list-group-item">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p style="word-wrap: break-word;"><?php echo $row->inventory;?></p>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p style="word-wrap: break-word;"><?php echo $row->containers;?></p>
                            </div>
                        </div>
                    </li>
                </ul>
